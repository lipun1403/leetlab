...
// //               {[ "JAVA","JAVASCRIPT", "PYTHON","CPP"].map((language) => (
// //                 <div
// //                   key={language}
...
const sampledpData = {
  ...
  hints:
    "To reach the nth step, you can either come from the (n-1)th step or the (n-2)th step.",
  editorial:
    "This is a classic dynamic programming problem. The number of ways to reach the nth step is the sum of the number of ways to reach the (n-1)th step and the (n-2)th step.",
  testcases: [
    { input: "2", output: "2" },
    { input: "3", output: "3" },
    { input: "4", output: "5" },
...
const sampleStringProblem = {
  ...
  editorial:
    "Use two pointers after ignoring non-alphanumeric characters and comparing lowercase characters.",
  testcases: [
                    ...
                    <div className="card bg-base-100 shadow-md">
                      <div className="card-body p-4 md:p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                          ...
                          />
                          <textarea
                            className="textarea textarea-bordered min-h-24 w-full p-3 resize-y md:col-span-2"
                            {...register(`examples.${language}.explanation`)}
                            placeholder="Explain the example"
                          />
                        </div>
